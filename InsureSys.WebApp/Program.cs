...
using Insurancesys.web.PolicyForms.Handlers;
...
namespace Insurancesys.web
{
    public static class Program
    {
        ...
        private static void RegisterDependency(WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<PolicyFormPersistence>();
            builder.Services.AddScoped<IPolicyFormHandler, MotorPolicyFormHandler>();
            builder.Services.AddScoped<IPolicyFormHandler, HealthPolicyFormHandler>();
            builder.Services.AddScoped<IPolicyFormHandler, LifePolicyFormHandler>();
            builder.Services.AddScoped<IPolicyFormHandler, PersonalAccidentPolicyFormHandler>();
            builder.Services.AddScoped<IPolicyFormHandler, StandardPolicyFormHandler>();
            builder.Services.AddScoped<IPolicyFormRegistry, PolicyFormRegistry>();
